...
import { LatestPrice } from 'src/app/portfolio/models/holding/latestPrice.model';
...
import { SortingCriteriaModel } from 'src/app/shared/components/toolbar/sorting-menu/sorting-menu.component';
